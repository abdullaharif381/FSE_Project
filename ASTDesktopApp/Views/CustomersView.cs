...
namespace ASTDesktopApp.Views
{
	public partial class CustomersView : SampleViews
	{
		...
		private void CustomerDataGridView_CellContentClick_2(object sender, DataGridViewCellEventArgs e)
		{
			if (CustomerDataGridView.CurrentCell.OwningColumn.Name == "dgvEdit")
			{
				AddCustomer addCustomer = new AddCustomer();
		...
		private void CustomerDataGridView_CellContentClick_3(object sender, DataGridViewCellEventArgs e)
		{
			if (CustomerDataGridView.CurrentCell.OwningColumn.Name == "dgvEdit")
			{
				AddCustomer addCustomer = new AddCustomer();
